...
Navigation.ipynb / Navigation.html: Where Deep Q-Learning is used to train the agent  
dqn_agent.py: The Agent  
model.py: The Deep Learning Model  
report.pdf / report.pages: A description of the learning algorithm and the implementation 
